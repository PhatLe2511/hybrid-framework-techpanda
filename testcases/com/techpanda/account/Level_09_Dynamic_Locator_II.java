...
@Test
public class Level_09_Dynamic_Locator_II extends BaseTest{
  ...
  @Test
	public void TC_01_Login_Valid_Password() {
  	...
  	public void TC_03_Footer_Page_Navigation() {
  		aboutUsPage = (AboutUsPageObject) dashboardPage.getFooterContainerPage(driver).openFooterContainerLinks("About Us");
  		
  		contactUsPage = (ContactUsPageObject) aboutUsPage.openFooterContainerLinks("Contact Us");
  	  		
  		searchTermsPage = (SearchTermsPageObject) contactUsPage.openFooterContainerLinks("Search Terms");
  		
  		footerMyAccountPage =  (MyAccountPageObject) searchTermsPage.openFooterContainerLinks("My Account");	
  	}
